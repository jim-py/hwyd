...
class NalogRuPython:
    ...
    def __init__(self):
        self.__session_id = '66152560ba09165286886773:6bb0bbdd-23e0-479a-a519-9e652bd8be16'
        self.__refresh_token = 'ed18ca88-c6b0-4bd3-bf47-80588a7bdf93'
        # self.set_session_id()
...
if __name__ == '__main__':
    ...
    qr_code = "t=20240330T1054&s=1532.58&fn=7282440500222195&i=106380&fp=3723197000&n=1"
    ticket = client.get_ticket(qr_code)
    print(json.dumps(ticket, indent=4, ensure_ascii=False))

    client.refresh_token_function()
    qr_code = "t=20240216T1915&s=29900.00&fn=9961440300381637&i=68211&fp=2469164169&n=1"
    ticket = client.get_ticket(qr_code)
    print(json.dumps(ticket, indent=4, ensure_ascii=False))
